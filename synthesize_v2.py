...
def synthezise(mname,datapath,plotpath,ONAME,build=False,trace=False):
  ...
  if "InteractionNetwork" in mname:  # For interaction network
    ...
    #config["LayerName"]["concatenate"] = {}
    #config["LayerName"]["concatenate"]["Precision"] ='ap_fixed<9,1, AP_RND, AP_SAT>'

    config["LayerName"]["permute_1"] = {}
    config["LayerName"]["permute_1"]["Precision"] = inputPrecision
    #config["LayerName"]["permute_1"] = {}
    #config["LayerName"]["permute_1"]["Precision"] = 'ap_fixed<10, 2, AP_RND, AP_SAT>'
    ...
    #config["LayerName"]["conv1D_e1"]["ReuseFactor"] = 8  # divisors of nconst*(nconst-1)
    #config["LayerName"]["conv1D_e2"]["ReuseFactor"] = 8
    #config["LayerName"]["conv1D_e3"]["ReuseFactor"] = 8
    ...
    #config["LayerName"]["conv1D_n1"]["ReuseFactor"] = 8  # divisors of nconst
    #config["LayerName"]["conv1D_n2"]["ReuseFactor"] = 8
    #config["LayerName"]["conv1D_n3"]["ReuseFactor"] = 8
...
if __name__ == "__main__":
  ...
  models = [
    ...
    "model_QInteractionNetwork_Conv1D_nconst_8_De_08_nbits_8",
